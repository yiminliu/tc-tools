...
public class BalanceAuditManagerTest {

	private static final String APPNAME = "TSCPMVNE";
	
	private BalanceAuditManager balanceAuditManager;
	
	private int accountNo = 725079; //777278; //748545; //774945; //775078; //775364; // //734983; //699594; //734837; ///698864; //692247; //737294;  //711110; ////735041; 714620; //692247;//735041; //709192;//
	...
	public void setUp() throws Exception {
		...
		balanceAuditManager = (BalanceAuditManager)ctx.getBean("balanceAuditManager");
